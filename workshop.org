...
#+BEGIN_SRC clojure
  ...
  {:prefixes {"sg" "http://statistics.data.gov.uk/def/statistical-geography#"}
   :q [{:where [[?s "rdf:type" "schema:TradeAction"]
                ...
                [?borough "sg:hasExteriorLatLongPolygon" ?poly]]}]
   :select [?zip ?price ?date ?boroughID ?poly]}
  ...
  {:prefixes {"sg" "http://statistics.data.gov.uk/def/statistical-geography#"}
   ...
   :group-by ?boroughID
   :select [?boroughID ?apoly ?num ?avg]}
  ...
  {:prefixes {"sg" "http://statistics.data.gov.uk/def/statistical-geography#"}
   ...
   :group-by ?boroughID
   :select [?boroughID ?apoly ?num ?aname]}

  {"E...." #{{?boroughID "E..." ?apoly #{"...."} ?num 123 ?avg 456}}
#+END_SRC
